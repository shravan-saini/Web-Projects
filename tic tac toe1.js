...
window.alert("hwlloji");

document.getElementById("p1name").innerHTML=localStorage.getItem("aplayer1[0]");
document.getElementById("turn").innerHTML="It's "+localStorage.getItem("aplayer1[0]")+"'s turn to go-";
document.getElementById("p2name").innerHTML=localStorage.getItem("aplayer2[0]");
...
function clicked(index){
	...
	if(turn==1)
	{
		...
		document.getElementById("turn").innerHTML="It's "+localStorage.getItem("aplayer2[0]")+"'s turn to go-";
		turn=0;
		return;
	}
	if(turn==0)
